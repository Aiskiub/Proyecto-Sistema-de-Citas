...
class GestionDeCitas:
    def __init__(self, gestion_medicos):
        ...
        # Guardar la instancia de GestionDeMedicos
    ...
    def asignar_cita(self, paciente, medico, fecha_str, hora):
        ...
        if medico.verificar_disponibilidad(fecha_programacion, hora, duracion):
            ...
            medico.eliminar_horario_disponible(
                fecha_programacion, hora)  # Eliminar horario disponible
            print(f"Cita asignada: {cita}")
            return True
        else:
            print(
                f"El horario {hora} el {fecha_str} no está disponible para el Dr. {medico.nombre} {medico.apellido}.")
            return False
    ...
    def cancelar_cita(self, paciente):
        ...
        if paciente.cita != -1:
            ...
            cita.medico.agregar_horario_disponible(
                cita.fecha_programacion, cita.hora_asignacion)
            paciente.cita = None
